...
export interface FormErrors {
  [key: string]: string | FormErrors | string[] | undefined;
  fullName?: string;
  phone?: string;
  dateOfBirth?: string;
  Biography?: string;
...
export interface FormTouched {
  [key: string]: boolean | FormTouched | boolean[] | undefined;
  fullName?: boolean;
  phone?: boolean;
  dateOfBirth?: boolean;
  Biography?: boolean;
  eduQulification?: boolean;
  experience?: boolean;
  ...
  website?: boolean;
  expertise?: boolean | boolean[];
  languages?: boolean | boolean[];
  address?: {
    street?: boolean;
    city?: boolean;
    state?: boolean;

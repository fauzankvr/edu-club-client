    ...
    const setRoleAndStartCall = async () => {
      await new Promise<void>((resolve) => {
        ...
        socket.once("role-set", () => {
          console.log(`Role set for instructor: ${role}`);
          resolve();
        });
      });
      ...
      const startCall = async () => {
        try {
          ...
          console.log("Emitting join-room for Instructor");
          socket.emit("join-room", "Instructor", roomId);
          ...
          socket.on("call-history", (history: CallRecord[]) => {
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        <div className="w-full md:w-64 bg-white border-r border-gray-200 flex flex-col">
          <div className="p-3 border-b border-gray-200">
            <h2 className="font-semibold text-gray-700">Call History</h2>
          </div>
